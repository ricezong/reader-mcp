...
预期返回 9 个工具：`reader_list_sources`、`reader_search_novel`、`reader_search_comic`、`reader_search_novel_by_author`、`reader_search_comic_by_author`、`reader_book_info`、`reader_chapters`、`reader_content`、`reader_download`。
